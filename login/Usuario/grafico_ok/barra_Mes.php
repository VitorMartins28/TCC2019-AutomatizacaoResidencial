<?php 
  ...
  $sql = "SELECT SUM(kwh) kwh, DATE_FORMAT(DATA, '%m/%Y') data_ from lampada
  ...
  <body background="assets/img/backgrounds/fundo.png">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><a href="barra_Ano.php">Gráfico Anual</a></li>
            <li><a href="barra_Dqs.php">Gráfico Qunzenal</a></li>
    ...
    <script type="text/javascript">
      ...
      <?php 
        ...
        $newDate2 = date("M/Y", strtotime($origDate2));
      ?>
        ...
        <form action="" method="POST">
          <div class="row">
            <div class="col-md-6 col-xs-12">
              ...
              <input type="month" id="data_inicial" name="data_inicial" class="form-control" value= <?php echo $origDate; ?>> 
            </div>
            <div class="col-md-6 col-xs-12">
              <label>Data Final</label> 
              <input type="month" id="data_final" name="data_final" class="form-control" value= <?php echo $origDate2; ?>>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div id="chart_div" class="graficochart"></div>
          </div>   
      </div>
