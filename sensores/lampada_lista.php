...
$consulta = mysql_query("select * from lampada");
?>
...
<body>
  <form action="deletar_lampada.php" method="POST">
<table class="table table-hover">
  ...
  <tbody>
    ...
    <tr class="row100 body">
      ...
      <td><?php echo $linhas->kwh;?>&nbsp; </td>
      <td><?php echo $linhas->data;?>&nbsp;</td>
      <td><?php echo $linhas->local;?>&nbsp; </td>
      <td><?php echo $linhas->voltagem;?>&nbsp; </td>
      <td><a href="deletar_lampada.php?codigo=<?php echo $linhas->ID;?>" class="style2">X</a></td>
    </tr>
