...
<form action="cadastra_sensor.php" method="POST">
  <div class="row">
      ...
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" name="local" id="local" placeholder="Digite o valor">
      </div>
	</div>
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" class="form-control" name="potencia" id="potencia" placeholder="Digite o local">
      </div>
<!-- 	  <div class="form-group col-md-3">
	...
	<div class="row">
	  <div class="col-md-12">
	  	<button type="submit" name="cadastrar" id="cadastrar" class="btn btn-primary">Salvar</button>
